<%-- 
    Document   : index
    Created on : Jan 10, 2020, 5:02:15 PM
    Author     : Ignacio
--%>
    ...
    <body class="container-fluid px-0">
        <div class="container px-0 min-100 border">
                    ...
                    <div class="col"
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb pb-0 pt-0 rounded-0 border-bottom">
                              ...
                              <li class="breadcrumb-item active" aria-current="page">Entero(s) con más dígitos pares</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            <div class="container">
                ...
                <div class="row mb-2">
                    <div class="col">
                        <h1 class="light-title">Entero(s) con más dígitos pares</h1>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
                       
                        <form action="${pageContext.request.contextPath}/lab2/pardigits" method="POST">
