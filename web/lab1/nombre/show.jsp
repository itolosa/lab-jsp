    ...
    <body class="container-fluid px-0">
        <div class="container px-0 min-100 border">
                    ...
                    <div class="col"
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb pb-0 pt-0 rounded-0 border-bottom">
                              ...
                              <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/lab1/nombre/index.jsp">Repetir nombre</a></li>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col">
                        <a href="${pageContext.request.contextPath}/lab1/nombre/index.jsp">Volver</a>
                    </div>
                </div>
            </div>
        </div>
